...
var Item = /** @class */ (function () {
    ...
    Item.prototype.toJSON = function () {
        ...
        return {
            ...
            phraseId: (_a = this.phrase) === null || _a === void 0 ? void 0 : _a.id,
        };
    };
...
var Cluster = /** @class */ (function () {
    ...
    Cluster.prototype.getItems = function (params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        urlParams = (0, mapping_1.buildClusteringQueryParams)(params);
                        /* istanbul ignore next */
                        return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(this.collection.client.getPaginated("".concat(this.collection.id, "/clusters/").concat(this.id, "/items?").concat(urlParams), 'items', function (item) { return Item.fromJSON(Phrase.fromJSON(_this, {
                                phrase_id: item.phrase.id,
                                text: item.phrase.text,
                                cluster: item.cluster,
                            }), item); }, params === null || params === void 0 ? void 0 : params.limit, params))))];
                    case 1: 
                    /* istanbul ignore next */
                    return [4 /*yield*/, __await.apply(void 0, [_a.sent()])];
                    case 2:
...
var _Collection = exports._Collection = /** @class */ (function () {
    function _Collection(id, params) {
        this.id = id;
        this.params = params;
    }
    _Collection.prototype.create = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.post("".concat(this.id, "/create"), {
                        access: (params === null || params === void 0 ? void 0 : params.access) || DEFAULT_ACCESS_PARAMS,
                        domain: (params === null || params === void 0 ? void 0 : params.domain) || 'curation',
                        allowed_api_keys: params === null || params === void 0 ? void 0 : params.allowedApiKeys,
                        cluster_distance_threshold: params === null || params === void 0 ? void 0 : params.clusterDistanceThreshold,
                        phrase_distance_threshold: params === null || params === void 0 ? void 0 : params.phraseDistanceThreshold,
                    })];
            });
        });
    };
    _Collection.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.delete(this.id)];
            });
        });
    };
...
var createCollectionClass = function (client) { return /** @class */ (function (_super) {
    ...
    Collection.getTaskStatus = function (taskId, params) {
        return __awaiter(this, void 0, void 0, function () {
            var urlParams;
            return __generator(this, function (_a) {
                urlParams = (0, mapping_1.buildClusteringQueryParams)(params);
                /* istanbul ignore next */
                return [2 /*return*/, client.get("status/".concat(taskId, "?").concat(urlParams), params)];
            });
        });
    };
    return Collection;
