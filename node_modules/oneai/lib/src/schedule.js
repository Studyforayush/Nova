    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    response = _a.sent();
                    logger === null || logger === void 0 ? void 0 : logger.debugNoNewline("Processing file ".concat(task.name, " - status ").concat(response.status, " - ").concat((0, logging_1.timeFormat)(Date.now() - timeStart)));
                    /* istanbul ignore if */
                ...
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    logger === null || logger === void 0 ? void 0 : logger.debugNoNewline("Processing of file ".concat(task.name, " complete - took ").concat((0, logging_1.timeFormat)(Date.now() - timeStart), " total\n"));
