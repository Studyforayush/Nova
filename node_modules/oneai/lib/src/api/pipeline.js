...
var PipelineApiClient = /** @class */ (function () {
    function PipelineApiClient(client, logger) {
        this.rootPath = 'api/v0/pipeline';
        this.client = client;
        this.logger = logger;
    }
    PipelineApiClient.prototype.postPipeline = function (input, skills, params) {
    ...
    PipelineApiClient.prototype.getTaskStatus = function (task, params) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, (0, mapping_1.buildAsyncApiResponse)(task, response.data, response.headers)];
                }
            });
        });
    };
...
exports.default = PipelineApiClient;
